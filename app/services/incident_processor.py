...
class IncidentProcessor:
    ...
    # ----------------------------
    # Build AI prompt to return structured JSON
    # ----------------------------
    ...
    # ----------------------------
    # Enforce at least 10 resolution steps
    # ----------------------------
    def _ensure_ten_steps(self, steps: Optional[List[str]]) -> List[str]:
        ...
        if not steps or not isinstance(steps, list):
            steps = []
        # Keep AI-provided steps and fill to 10 with defaults
    ...
    # ----------------------------
    # Generate PDF from IncidentAnalysisModel
    # ----------------------------
    ...
    async def analyze_incident_only(self, sys_id: str, analysis_type: str = "general") -> Dict[str, Any]:
        ...
        try:
            ...
            ai_analysis = await self.openai_service.generate_text(
                {
                    "prompt": prompt,
            ...
            validated_struct = IncidentAnalysisModel(
                ...
                issue_category=str(parsed_json.get("issue_category") or "Other"),  # Default fallback
