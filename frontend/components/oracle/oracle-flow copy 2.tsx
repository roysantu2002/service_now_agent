...
const steps = [
  {
    ...
    title: "Observe",
    description:
      "AI continuously monitors inbound tickets, logs, and alerts to detect patterns and pain points.",
    icon: "👁️",
  },
  {
    number: "2",
  ...
  },
  {
    ...
    title: "Analyse",
    description:
      "Evaluate root causes, recommend resolutions, and identify duplicate incidents with precision.",
    icon: "⚙️",
  },
  {
    number: "4",
    title: "Collaborate",
    description:
      "AI pairs with teams through co-pilot workflows, reducing cognitive load and improving efficiency.",
    icon: "🤝",
  },
  {
    number: "5",
    title: "Learn",
    description:
      "Post-resolution feedback loops refine predictions and improve accuracy over time.",
    icon: "📚",
  },
  {
    number: "6",
    title: "Execute",
    description:
      "Auto-resolve eligible tickets, populate notes, and trigger workflows automatically.",
    icon: "⚡",
  },
];
...
function VerticalTimelineStep({
  ...
  return (
    <div className="flex items-stretch gap-8 mb-8 lg:mb-12">
          ...
          >
            <div className="flex items-start gap-3 mb-4">
              ...
              <div className="flex-1">
                <h3
                  className={`text-lg sm:text-xl font-bold mb-1 ${colors.text}`}
                >
                  {step.title}
                </h3>
                <p
      ...
      {/* Center timeline (circle + horizontal connector; vertical line is global) */}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16" ref={containerRef}>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Watch how a ticket flows through six intelligent steps—from initial
            observation to automated execution
          </p>
        </div>

        {/* Desktop: Vertical timeline with alternating left-right layout */}
        <div className="relative hidden lg:block">
          {/* Timeline line that stops at the last circle */}
          <div className="absolute left-1/2 top-7 bottom-[calc(3.5rem)] w-1 bg-muted-foreground/30 -translate-x-1/2" />
        ...
        <div className="lg:hidden space-y-6">
          {steps.map((step, index) => {
            const colors =
              stepColors[step.number as unknown as keyof typeof stepColors];
