...
export function IncidentAnalysis({ onBack }: IncidentAnalysisProps) {
  ...
  const analysisMutation = useMutation({
    mutationFn: (sys_id: string) =>
      incidentService.analyzeIncident(sys_id, "general", llmPlatform),
        ...
        <Card className="max-w-2xl mx-auto">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="llmPlatform">LLM Platform</Label>
                <select
                  id="llmPlatform"
                  value={llmPlatform}
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Select the LLM platform for analyzing the incident
                </p>
              </div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {analysisResult?.usage?.total_tokens?.toLocaleString() ??
                      "-"}
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm">
                    {analysisResult?.usage?.completion_tokens?.toLocaleString() ??
                      "-"}
                  </p>
                </div>
              </div>
