      ...
      <div className="max-w-4xl mx-auto bg-gray-800 rounded-xl shadow-lg p-8 space-y-6">
        ...
        <div className="space-y-4 border-t border-gray-700 pt-4">
          ...
          <button
            ...
            disabled={loadingSubmit || !!submitResult}
          ...
          >
            {loadingSubmit ? <Loader2 className="w-5 h-5 animate-spin" /> : <Rocket className="w-5 h-5" />}
        ...
        {submitResult && (
          <div className="border-t border-gray-700 pt-4 space-y-4">
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              >
                {loadingFetch ? <Loader2 className="w-5 h-5 animate-spin" /> : <RefreshCcw className="w-5 h-5" />}
              ...
              >
                {loadingScript ? <Loader2 className="w-5 h-5 animate-spin" /> : <FileCode className="w-5 h-5" />}
                Generate Script
              </button>
            </div>
          </div>
