...
// Validate ../../app/services/incident/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/services/incident">> = Specific
  const handler = {} as typeof import("../../app/services/incident/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../app/api/v1/incidents/create/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/v1/incidents/create">> = Specific
  const handler = {} as typeof import("../../app/api/v1/incidents/create/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
